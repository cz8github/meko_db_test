...
--
-- Host: localhost
-- Generation Time: Feb 24, 2022 at 08:18 AM
...
CREATE TABLE `business_unit` (
  `id` int(11) NOT NULL,
  `business_unit_name` varchar(255) CHARACTER SET latin1 NOT NULL,
  `status` int(1) NOT NULL COMMENT '0 = Inactive , 1 = Active	',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int(3) NOT NULL COMMENT '99 as DBadmin , Reference ID users table	',
  `updated_at` datetime NOT NULL,
  `updated_by` int(3) NOT NULL COMMENT '99 as DBadmin , Reference ID users table	',
  `deleted_at` datetime NOT NULL,
  `deleted_by` int(3) NOT NULL COMMENT '99 as DBadmin , Reference ID users table	'
...
CREATE TABLE `category` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int(3) NOT NULL DEFAULT '99' COMMENT '99 as DBadmin , Reference ID users table',
  `updated_at` datetime NOT NULL,
  `updated_by` int(3) NOT NULL DEFAULT '99' COMMENT '99 as DBadmin , Reference ID users table',
  `deleted_at` datetime NOT NULL,
  `deleted_by` int(3) NOT NULL DEFAULT '99' COMMENT '99 as DBadmin , Reference ID users table',
  `business_unit_id` int(11) NOT NULL COMMENT 'Reference ID business unit table	'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `department` (
  ...
  `updated_by` int(3) DEFAULT NULL COMMENT '99 as DBadmin , Reference ID users table	',
  `deleted_at` datetime DEFAULT NULL,
  `deleted_by` int(3) DEFAULT NULL COMMENT '99 as DBadmin , Reference ID users table	'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `doctor_position` (
  `id` int(11) NOT NULL,
  `doctor_position_name` varchar(255) DEFAULT NULL,
...
CREATE TABLE `menu_control` (
  `id` int(11) NOT NULL,
  `menu_control_name` varchar(255) NOT NULL,
  `menu_control_part` varchar(255) NOT NULL,
  `menu_control_icon` varchar(255) DEFAULT NULL,
  `menu_control_main_sub` int(11) DEFAULT NULL COMMENT 'Main=0 , Other = sub',
  `menu_control_index` int(11) NOT NULL COMMENT '(sort)Index Menu',
  `menu_control_status` int(1) NOT NULL COMMENT '0 = Inactive , 1 = Active',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int(3) NOT NULL DEFAULT '99' COMMENT '99 as DBadmin , Reference ID users table	',
  `updated_at` int(11) DEFAULT NULL,
  `updated_by` int(3) DEFAULT '99' COMMENT '99 as DBadmin , Reference ID users table	',
  `deleted_at` int(11) DEFAULT NULL,
  `deleted_by` int(3) DEFAULT '99' COMMENT '99 as DBadmin , Reference ID users table	'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `preflix`
--

CREATE TABLE `preflix` (
  `id` int(11) NOT NULL,
  `preflix_th` varchar(10) NOT NULL,
  `preflix_en` varchar(10) NOT NULL,
  `status` int(1) NOT NULL DEFAULT '1' COMMENT '0=Inactive , 1=Active	'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `role_management` (
  `id` int(11) NOT NULL,
  `role_id` int(11) NOT NULL COMMENT 'FK_(Role)',
  `menu_id` int(11) NOT NULL COMMENT 'Reference ID Menu',
  `permission_acess` int(1) NOT NULL COMMENT '1 = view , 2 = Insert , 3 = Update , 4 = Delete',
  `status` int(1) NOT NULL COMMENT '0=Inactive , 1=Active',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int(3) NOT NULL DEFAULT '99' COMMENT '99 as DBadmin , Reference ID users table	',
  `updated_at` datetime DEFAULT NULL,
...
CREATE TABLE `sub_category` (
  ...
  `deleted_at` datetime DEFAULT NULL,
  `deleted_by` int(3) NOT NULL DEFAULT '99' COMMENT '99 as DBadmin , Reference ID users table	',
  `category_id` int(11) NOT NULL COMMENT 'Reference ID category table	'
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL COMMENT 'PK_Unique_id_users',
  `preflix_th` varchar(10) DEFAULT NULL,
  `name_th` varchar(255) DEFAULT NULL,
  `lastname_th` varchar(255) DEFAULT NULL,
  `department` int(11) DEFAULT NULL COMMENT 'FK from role(department)',
  `create_by_channel` int(2) DEFAULT '0' COMMENT '0=backend,1=google',
  `email` varchar(255) DEFAULT NULL,
  `username` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `token_google` varchar(255) DEFAULT NULL,
  `users_image` varchar(255) DEFAULT NULL,
  `status` int(1) NOT NULL DEFAULT '1' COMMENT '0=Inactive , 1=Active',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'timestamp when create data',
  `created_by` int(3) NOT NULL DEFAULT '99' COMMENT '99 as DBadmin , Reference ID Users Table',
  `updated_at` datetime DEFAULT NULL COMMENT 'timestamp when update data',
  `updated_by` int(3) NOT NULL DEFAULT '99' COMMENT '99 as DBadmin , Reference ID Users Table',
  `deleted_at` datetime DEFAULT NULL COMMENT 'timestamp when delete data',
  `deleted_by` int(3) NOT NULL DEFAULT '99' COMMENT '99 as DBadmin , Reference ID Users Table'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`, `preflix_th`, `name_th`, `lastname_th`, `department`, `create_by_channel`, `email`, `username`, `password`, `token_google`, `users_image`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES
(1, NULL, NULL, NULL, NULL, NULL, 'chalermchai.z@intervision.co', 'C', 'xxxx', NULL, NULL, 1, '2022-02-22 08:50:05', 99, '2022-02-22 08:50:05', 99, NULL, 99),
(2, NULL, NULL, NULL, NULL, NULL, 'chalermchai.z@intervision.co', 'Chalermchai Zaesur', 'xxxx', 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImFjYjZiZTUxZWZlYTZhNDE5ZWM5MzI1ZmVhYTFlYzQ2NjBmNWIzN2MiLCJ0eXAiOiJKV1QifQ.eyJpc3MiOiJhY2NvdW50cy5nb29nbGUuY29tIiwiYXpwIjoiNDcxODIwNTI2NTQ3LXVjOXVjdWtiNWluYXR2anNzcGFwN2h2YXRlZWswODRtLmFwcHMuZ29vZ2xldXNlcmNvbnRlbnQuY29tIiwiYXVk', NULL, 1, '2022-02-22 05:02:17', 99, '2022-02-22 05:02:17', 99, NULL, 99),
(3, NULL, NULL, NULL, NULL, NULL, 'chalermchai.z@intervision.co', 'Chalermchai Zaesur', 'xxxx', 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImFjYjZiZTUxZWZlYTZhNDE5ZWM5MzI1ZmVhYTFlYzQ2NjBmNWIzN2MiLCJ0eXAiOiJKV1QifQ.eyJpc3MiOiJhY2NvdW50cy5nb29nbGUuY29tIiwiYXpwIjoiNDcxODIwNTI2NTQ3LXVjOXVjdWtiNWluYXR2anNzcGFwN2h2YXRlZWswODRtLmFwcHMuZ29vZ2xldXNlcmNvbnRlbnQuY29tIiwiYXVk', NULL, 1, '2022-02-22 06:15:44', 99, '2022-02-22 06:15:44', 99, NULL, 99),
(4, NULL, NULL, NULL, NULL, 0, 'chalermchai.z@intervision.co', 'Chalermchai Zaesur', 'xxxx', 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImFjYjZiZTUxZWZlYTZhNDE5ZWM5MzI1ZmVhYTFlYzQ2NjBmNWIzN2MiLCJ0eXAiOiJKV1QifQ.eyJpc3MiOiJhY2NvdW50cy5nb29nbGUuY29tIiwiYXpwIjoiNDcxODIwNTI2NTQ3LXVjOXVjdWtiNWluYXR2anNzcGFwN2h2YXRlZWswODRtLmFwcHMuZ29vZ2xldXNlcmNvbnRlbnQuY29tIiwiYXVk', NULL, 1, '2022-02-22 08:45:11', 99, '2022-02-22 08:45:11', 99, NULL, 99),
(5, NULL, NULL, NULL, NULL, 0, 'chalermchai.z@intervision.co', 'Chalermchai Zaesur', 'xxxx', 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImFjYjZiZTUxZWZlYTZhNDE5ZWM5MzI1ZmVhYTFlYzQ2NjBmNWIzN2MiLCJ0eXAiOiJKV1QifQ.eyJpc3MiOiJhY2NvdW50cy5nb29nbGUuY29tIiwiYXpwIjoiNDcxODIwNTI2NTQ3LXVjOXVjdWtiNWluYXR2anNzcGFwN2h2YXRlZWswODRtLmFwcHMuZ29vZ2xldXNlcmNvbnRlbnQuY29tIiwiYXVk', 'https://lh3.googleusercontent.com/a/AATXAJz7xQEliYdTHexZcLfrlIoJROT5HYrCNGkWdMo=s96-c', 1, '2022-02-22 08:48:50', 99, '2022-02-22 08:48:50', 99, NULL, 99),
(6, NULL, NULL, NULL, NULL, 0, 'chalermchai.z@intervision.co', 'chalermchai.z@intervision.co', 'xxxx', 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImFjYjZiZTUxZWZlYTZhNDE5ZWM5MzI1ZmVhYTFlYzQ2NjBmNWIzN2MiLCJ0eXAiOiJKV1QifQ.eyJpc3MiOiJhY2NvdW50cy5nb29nbGUuY29tIiwiYXpwIjoiNDcxODIwNTI2NTQ3LXVjOXVjdWtiNWluYXR2anNzcGFwN2h2YXRlZWswODRtLmFwcHMuZ29vZ2xldXNlcmNvbnRlbnQuY29tIiwiYXVk', 'https://lh3.googleusercontent.com/a/AATXAJz7xQEliYdTHexZcLfrlIoJROT5HYrCNGkWdMo=s96-c', 1, '2022-02-22 08:50:05', 99, '2022-02-22 08:50:05', 99, NULL, 99);
...
--
-- Indexes for table `doctor_position`
--
...
--
-- AUTO_INCREMENT for table `doctor_position`
--
ALTER TABLE `doctor_position`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `preflix`
--
ALTER TABLE `preflix`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK_Unique_id_users', AUTO_INCREMENT=7;
COMMIT;
